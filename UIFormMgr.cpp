...
CFormMgr::CFormMgr()
: _bEnabled(false), _bInit(false), _nEnableHotKey(0xFFFFFFFF), _nTempleteNo(-1), /*_nMouseHover(0),*/ _pHintGui(nullptr)	// �����ĵ��޸�
{
...
{
	if( no>=(int)GetFormTempleteMax() || no<-1 ) return nullptr;
