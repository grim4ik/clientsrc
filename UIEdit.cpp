...
, _color(COLOR_BLACK), evtKeyDown(nullptr), evtKeyChar(nullptr), _nLeftMargin(0), _nTopMargin(2), evtEnter(nullptr)
, evtChange(nullptr), _pEnterButton(nullptr), _nCursorColor(COLOR_BLACK)
{
	_IsFocus = true;
