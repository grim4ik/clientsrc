...
: CCompent(frmOwn), _nColSpace(4), _nRowSpace(5), _pRoot(nullptr), _IsAutoExpand(true)
, evtSelectChange(nullptr), evtMouseDown(nullptr), evtSelectLost(nullptr)
, evtItemLost(nullptr), evtItemChange(nullptr), evtMouseDragEnd(nullptr)
, _pDragItem(nullptr), _pDragNode(nullptr), evtMouseDB(nullptr), _dwSelectColor(COLOR_BLACK)
{
	// _IsFocus = true;
