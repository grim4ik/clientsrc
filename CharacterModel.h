...
public:
	...
	void PlayPose( DWORD pose, DWORD type = PLAY_ONCE, int time=-1, int fps = FPSModifier, DWORD blend_flag = 1, DWORD blend_src_num = 5, float velocityMultiplier = 1.0f  );   // LoopSpeed,���ٺ���Poseѭ��һ��
