...
public:
    ...
    static CGuiPic* GetFacePic( unsigned int n ) { if( n>=FACE_MAX) return nullptr; return &_pImgFace[n]; }
    static CGuiPic* GetShopPic( unsigned int n ) { if( n>=3) return nullptr; return &_ImgShop[n]; }
