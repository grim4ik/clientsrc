...
CGameScene*	CGameApp::_pCurScene			= nullptr;
...
#pragma message("-------------Primitive Culling Closed-------------")
	...
	//LPD3DXBUFFER	pbuff;
	//D3DXCreateEffectFromFile(g_Render.GetDevice(),"shader\\dx8\\eff.fx",&peff,nullptr);
	//peff->GetCompiledEffect(&pbuff);
	//if(FAILED(D3DXCreateEffect(g_Render.GetDevice(),pbuff->GetBufferPointer(),pbuff->GetBufferSize(),&peff2,nullptr)))
	//{
	//	INT EF = 0;
	//}
...
void CGameApp::PlaySample( std::string SoundName )
{
