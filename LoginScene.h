...
public:	
	...
	// logo hint
	//static void ShowHintLogo(int isShow);
...
private:
	...
	// logo hint
	//static CForm*			frmHintLogo;

	//static CList*			lstRegion[NUM_REGIN_LIST];
	//static CListView*		lstServer[NUM_SERVR_LIST];

	static CList*			lstRegion0;
	static CList*			lstRegion1;
	static CListView*		lvServer0;
	static CListView*		lvServer1;
