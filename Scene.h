...
public:
	...
	//mothannakh daylight depends on server time
	void DaylightByServerTime(D3DLIGHTX& env_light, DWORD& env_color, CAreaInfo* pArea);
	void DaylightByServerTime2(D3DLIGHTX& env_light, MPDwordByte4& db_color, D3DXCOLOR& c, CAreaInfo* pArea, MPTile*& tile, float& fLgt);
public:	
...
public:
	...
	static void		ResetMainCha()		{ _pMainCha = nullptr;		}
