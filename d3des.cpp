...
void makekey(char *aptr/* nullptr-terminated  */, unsigned char *kptr/* unsigned char[8] */)
{
...
void make2key(char *aptr/* nullptr-terminated   */, unsigned char *kptr/* unsigned char[16] */)
{
	register unsigned char *store;
	register int first, i;
	unsigned long savek[96];
...
void make3key(char *aptr/* nullptr-terminated   */, unsigned char *kptr/* unsigned char[24] */)
{
	register unsigned char *store;
	register int first, i;
	unsigned long savek[96];
