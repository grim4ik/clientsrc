...
const char* CCreateChaScene::GetDescripts(int index)
{
	...
	{
	case 0:
		return g_oLangRec.GetString(35);
	case 1:
		return g_oLangRec.GetString(36);
	case 2:
		return g_oLangRec.GetString(37);
	case 3:
		return g_oLangRec.GetString(38);
	}
	return "";
};
...
const char* CCreateChaScene::GetCityNames(int index)
{
	...
	{
	case 0:
		return g_oLangRec.GetString(39);
	case 1:
		return g_oLangRec.GetString(40);
	case 2:
		return g_oLangRec.GetString(41);
	}
...
const char* CCreateChaScene::GetCitiesDescripts(int index)
{
	...
	{
	case 0:
		return g_oLangRec.GetString(42);
	case 1:
		return g_oLangRec.GetString(43);
	case 2:
		return g_oLangRec.GetString(44);
	}
...
void CCreateChaScene::ChangeFace(eDirectType enumDirect)
{
    ...
    if (nullptr == m_pChaForUI[m_nSelChaIndex]) return;
...
void CCreateChaScene::SendChaToServ()
{
    ...
    CS_NewCha2( edtName->GetCaption(), GetCityNames(m_nCurCityIndex), sTypeID,sHairID,faceID );
...
void CCreateChaScene::CreateNewCha()
{
    ...
    std::string  sName = edtName->GetCaption();
