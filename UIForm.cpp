...
, evtShow(nullptr), evtHide(nullptr), evtActive(nullptr), evtLost(nullptr), evtMouseDown(nullptr), evtHotkeyHandler(nullptr)
, evtEntrustMouseEvent(nullptr), evtKeyDown(nullptr), evtKeyChar(nullptr), _cHotKey(0) ,_formStyle(fsNone),_IsEscClose(true)
, evtMouseDragEnd(nullptr), evtOnSetScreen(nullptr), _pPointer(nullptr), _pPopMenu(nullptr)
, evtClose(nullptr), _pEnterButton(nullptr), evtBeforeShow(nullptr), evtEscClose(nullptr)
{
...
{
    if( _actives.empty() ) return nullptr;
